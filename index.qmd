...
p1 <- ggplot(org_counts, aes(x = n, y = Organization, text = paste0(Organization, ": ", n))) +
...
p2 <- ggplot(rwd_types, aes(x = n, y = `RWD Type`, fill = n, text = paste0(`RWD Type`, ": ", n))) +
  geom_col() +
...
p3 <- ggplot(topics, aes(x = n, y = Topic, text = paste0(Topic, ": ", n))) +
