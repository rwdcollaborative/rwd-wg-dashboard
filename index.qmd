...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function statusLabel(status) {
    if (status === "ok") return "Link Check: OK";
    if (status === "dead") return "Link Check: Dead";
    if (status === "warn") return "Link Check: Warn";
    return "Link Check: Unknown";
  }
      ...
      if (statusIdx >= 0) {
        const tryApply = function () {
          ...
          indexes.forEach(function (idx) {
            ...
            rowData[7] = updateDetailValue(rowData[7], "Link Check Status", meta.status || "Unknown");
            rowData[7] = updateDetailValue(rowData[7], "Link Check Time", meta.checkedAt || "Unknown");
            rowData[7] = updateDetailValue(rowData[7], "Link Check Detail", meta.detail || "Unknown");
